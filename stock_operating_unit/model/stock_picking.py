...
class StockPicking(models.Model):
    ...
    antar_cabang = fields.Boolean(
        string='Antar Cabang', related='picking_type_id.antar_cabang')
    ...
    class PickingType(models.Model):
        ...
        operating_unit_id = fields.Many2one(
            'operating.unit', related='warehouse_id.operating_unit_id', string='Operating Unit')
